...
var requests = exports.requests = [[{ "building": true, "address": "119 W 24th St, New York, NY" }, { "building": true, "address": "99 Margaret Corbin Dr, New York, NY" }, { "building": true, "address": "1000 5th Ave, New York, NY" }], [{ "building": true, "address": "118 w 42nd st, new york, ny" }, { "building": true, "address": " stainway st, astoria, queens, ny" }]];
...
var _LocationCardList = __webpack_require__(32);

var _LocationCardList2 = _interopRequireDefault(_LocationCardList);
...
var Mapfit = function (_Component) {
  _inherits(Mapfit, _Component);

  function Mapfit(props) {
    _classCallCheck(this, Mapfit);

    var _this = _possibleConstructorReturn(this, (Mapfit.__proto__ || Object.getPrototypeOf(Mapfit)).call(this, props));

    _this.apiEndpoint = 'https://api.mapfit.com/v1/geocode';
    //in a prod environment this would be hidden away
    _this.apiKey = '591dccc4e499ca0001a4c6a4376d9e037bb8498a5d301c0f08a1f275';
    _this.mapDOMId = 'map';
    _this.state = {
      theme: 'day',
      popups: 'cardsOn',
    ...
    _this.drawMap = _this.drawMap.bind(_this);
    _this.encodeMarker = _this.encodeMarker.bind(_this);
    return _this;
  }
  ...
  _createClass(Mapfit, [{
    ...
    value: function componentWillMount() {
      ...
      this.props.requests.forEach(function (request) {
        fetch(_this2.apiEndpoint + '?api_key=' + _this2.apiKey, {
          method: 'POST',
          ...
          _this2.setState({
            points: [].concat(_toConsumableArray(_this2.state.points), _toConsumableArray(points))
          });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'row' },
        _react2.default.createElement(_LocationCardList2.default, { locations: this.state.points }),
        _react2.default.createElement(
          'div',
          { id: 'mapWrapper', className: 'col-sm-9' },
          _react2.default.createElement('div', { id: this.mapDOMId })
        )
      );
    }
  }, {
    ...
    value: function componentDidMount() {
      var _state = this.state,
          ...
          zoomEnabled = _state.zoomEnabled,
          externalNav = _state.externalNav;
      ;
    ...
    key: 'encodeMarker',
    value: function encodeMarker(point) {
    ...
    key: 'drawMap',
    value: function drawMap(markers) {
      console.log(markers);
...
// module
exports.push([module.i, "#mapContainer {\n  padding: 0 15px;\n  width: 99%;\n  border: solid 1px rgba(0, 0, 0, 0.125);\n  margin: 20px auto;\n}\n#mapContainer #mapWrapper {\n  padding: 0;\n  position: relative;\n  height: 635px;\n}\n#mapContainer #sidebar {\n  padding: 0;\n}\n#mapContainer #sidebar h4 {\n  padding: 12px 20px;\n  border: solid 1px rgba(0, 0, 0, 0.125);\n  margin: 0 0 -1px 0;\n  color: #0955ec;\n}\n#mapContainer #sidebar .list-group .list-group-item {\n  height: 100px;\n  color: #000;\n}\n#mapContainer #sidebar .list-group .list-group-item.prev,\n#mapContainer #sidebar .list-group .list-group-item.next {\n  height: 50px;\n  font-size: 12px;\n  height: auto;\n  border-radius: 0;\n}\n", ""]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(5);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(8);var _assign=__webpack_require__(4);var emptyFunction$1=__webpack_require__(2);var EventListener=__webpack_require__(7);var getActiveElement=__webpack_require__(11);var shallowEqual=__webpack_require__(12);var containsNode=__webpack_require__(9);var focusNode=__webpack_require__(10);var emptyObject=__webpack_require__(3);var checkPropTypes=__webpack_require__(13);var hyphenateStyleName=__webpack_require__(22);var camelizeStyleName=__webpack_require__(20);/**
...
var _Mapfit = __webpack_require__(16);

var _Mapfit2 = _interopRequireDefault(_Mapfit);
...
(0, _reactDom.render)(_react2.default.createElement(_Mapfit2.default, { requests: _requests.requests }), document.getElementById('mapContainer'));
...
var LocationCard = function (_Component) {
...
var _LocationCard = __webpack_require__(31);
...
var LocationCardList = function (_Component) {
  _inherits(LocationCardList, _Component);

  function LocationCardList() {
    _classCallCheck(this, LocationCardList);

    return _possibleConstructorReturn(this, (LocationCardList.__proto__ || Object.getPrototypeOf(LocationCardList)).apply(this, arguments));
  }

  _createClass(LocationCardList, [{
    key: 'render',
    value: function render() {
      var locationCards = this.props.locations.map(function (location, i) {
        return _react2.default.createElement(_LocationCard2.default, _extends({ key: i }, location));
      });
      return _react2.default.createElement(
        'div',
        { id: 'sidebar', className: 'col-sm-3' },
        _react2.default.createElement(
          'h4',
          null,
          'Our Locations'
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { href: '#', className: 'list-group-item prev' },
            _react2.default.createElement(
              'strong',
              null,
              'See Previous Five'
          ...
          _react2.default.createElement(
            'a',
            { href: '#', className: 'list-group-item next active' },
            _react2.default.createElement(
              'strong',
              null,
              'See Next Five'
...
exports.default = LocationCardList;
